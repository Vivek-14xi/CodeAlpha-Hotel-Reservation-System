...
public class Room {
    ...
    public Room(int roomNumber, RoomType roomType) {
        ...
        this.isAvailable  = true;    // default: available on creation
        ...
        this.amenities = switch (roomType) {
            ...
            case DELUXE   -> "TV, WiFi, AC, Mini-Bar, City View";
            case SUITE    -> "TV, WiFi, AC, Mini-Bar, Jacuzzi, Kitchen, Ocean View";
        };
    }
